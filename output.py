...
class Output:
	...
	def promptOK(self, message):   # Output format for success messages
		print(self.green + '[+] ' + message + self.endcolor)

	def promptFail(self, message): # Output format for failure messages
		print(self.red + '[-] ' + message + self.endcolor)

	def promptInfo(self, message): # Output format for information
